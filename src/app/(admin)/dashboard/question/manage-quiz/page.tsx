...
import ModalCreateQuiz from "@/components/admin/quiz/question.modal.create";
...
const ManageQuiz = () => {
  ...
  const handleDetailQuiz = (quizId: string) => {
    // Navigate to the quiz detail page
    router.push(`/dashboard/question/manage-quiz/${quizId}`); // Replace `/quiz/${quizId}` with your actual route
  };
    ...
    <>
      ...
      >
        {quiz.map((quizItem) => (
          <div
            key={quizItem._id}
            onClick={() => handleDetailQuiz(quizItem._id)}
          >
